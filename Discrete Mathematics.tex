...
\begin{enumerate}[label=\big(\alph*\big)]
    ...
    \begin{align*}
        ...
        P &= n!
    \end{align*}
    Why is this true, because, as we already saw in the tree diagram, when we add one object to the permutations, we can instert it either at the beginning or after any other. So the number of permutations multiply by $n$, giving us $n!$.
\end{enumerate}
